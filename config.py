...
APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzUTanv_MfxFKFUNS1dQ8kUImwpGAWv2qPCXxLagNPddSDUgTrZtLkOBdMc0HsWIR-R/exec"

# сколько результатов поиска показывать
SEARCH_LIMIT = 10